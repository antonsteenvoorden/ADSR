...
class BSR_USER(nn.Module):
    def __init__(self, item_num, user_num, num_item_units=256, num_user_units=100, num_gru_units=100,
        ...
        super(BSR_USER, self).__init__()
        self.item_num = item_num
        self.user_num = user_num
        self.num_gru_units = num_gru_units
        after_encoding_dim = num_gru_units * 2
        ...
        self.item_encoder_GRU = nn.GRU(input_size=num_item_units+num_user_units,
    ...
    def forward(self, inputs):
        ...
        item_input = torch.cat([item_x_embedded, user_embedded], dim=-1)
