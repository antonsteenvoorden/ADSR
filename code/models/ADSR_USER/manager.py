...
class ADSR_USER_Manager(Model):
    name = "The ADSR+User extends MTASR with the ADD module and also uses the user identifier to obtain representations" \
           "It diversifies the recommendations by trading of accuracy and diversity. "
    ...
    def __init__(self, args):
        ...
        super(ADSR_USER_Manager, self).__init__(required_keys, **vars(args))
