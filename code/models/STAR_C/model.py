...
class STAR_C(nn.Module):
    ...
    def rnn_step(self, item_x, context_x, hidden=None, hidden_2=None):
        ...
        # RNN 1
        h3 = torch.sigmoid(F.linear(context_x.unsqueeze(1), self.WIntervalX, self.BIntervalX) + self.LinearH3(hidden_2))
        # we pass h3 into 2nd layer of context rnn to generate weight matrix of size (D,D)
