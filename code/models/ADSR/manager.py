...
class ADSR_Manager(Model):
    name = "The Attribute-aware Diversifying Sequential Recommender extends MTASR with the ADD module " \
           "which diversifies the recommendations by trading of accuracy and diversity"
    ...
    def __init__(self, args):
        ...
        super(ADSR_Manager, self).__init__(required_keys, **vars(args))
