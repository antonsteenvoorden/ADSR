...
class ANAM_Manager(Model):
    name = "The Attribute-aware Neural Attentitive Model incorporates attribute information when " \
           "obtaining the representations."
    ...
    def __init__(self, args):
        ...
        super(ANAM_Manager, self).__init__(required_keys, **vars(args))
