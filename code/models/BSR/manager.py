...
class BSR_Manager(Model):
    name = "The Base Sequential Recommender is not an attribute-aware model. " \
           "It only uses the sequence of item interactions to generate hidden representations." \
    ...
    def __init__(self, args):
        ...
        super(BSR_Manager, self).__init__(required_keys, **vars(args))
    ...
    def _set_dataloaders(self, train_path, valid_path, test_path, batch_size, num_workers=4):
        train_loader, val_loader, test_loader, item_num, user_num, _ = get_data_loaders(train_path,
                                                                                     valid_path,
                                                                                     test_path,
                                                                                     batch_size,
